...
register(
    id="InvertedPendulumBulletEnv-v1",
...
register(
    id="InvertedDoublePendulumBulletEnv-v1",
...
register(
    id="InvertedPendulumSwingupBulletEnv-v1",
...
register(
    id="HumanoidFlagrunHarderBulletEnv-v1",
