...
from pybullet_envs_gymnasium.robot_bases import MJCFBasedRobot
...
class Pusher(MJCFBasedRobot):
    ...
    def robot_specific_reset(self, bullet_client):
        ...
        self.target_pos = (
            ...
            * self.np_random.uniform(low=self.min_target_placement_radius, high=self.max_target_placement_radius, size=1)
        )
        ...
        self.object_pos = (
            ...
            * self.np_random.uniform(low=self.min_object_to_target_distance, high=self.max_object_to_target_distance, size=1)
        )
...
class Thrower(MJCFBasedRobot):
    ...
    def robot_specific_reset(self, bullet_client):
        ...
        self.object_pos = (
            ...
            * self.np_random.uniform(low=self.min_object_placement_radius, high=self.max_object_placement_radius, size=1)
        )
